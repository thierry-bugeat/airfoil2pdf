...
sub creerPdf{
	...
	$this->{pdf} = new PDF::Create(
				...
				'Author'   => 'aeromodelisme.boonga.com',
				'Title'    => 'BOONGA'
				);
...
sub _pdf_creer_la_page_de_garde{
	...
	$_page0->stringc($this->{font1}, $this->{xxlarge}, ($this->{pdf_largeur}/2) , (($this->{pdf_hauteur}/2)+_mm2pixels(30,$this->{dpi})), 'BOONGA.COM');
	$_page0->stringc($this->{font1}, $this->{large}, ($this->{pdf_largeur}/2) , (($this->{pdf_hauteur}/2)+_mm2pixels(22,$this->{dpi})), 'Module de generation de nervures pour l\'aeromodelisme '.$this->{version});
	...
	$_page0->stringc($this->{font1}, $this->{medium}, ($this->{pdf_largeur}/2) , ($this->{pdf_marges}+(30/2)), "Site internet : www.boonga.com - Email : email\@boonga.com");
...
sub _pdf_entete_page{
	...
	$$ref->stringc($this->{font1}, 20, (($this->{pdf_largeur})/2) , ($this->{pdf_hauteur} - $this->{pdf_marges} - 40) , 'BOONGA.COM');
	...
	$$ref->stringc($this->{font1}, 16, (($this->{pdf_largeur})/2) , ($this->{pdf_hauteur} - $this->{pdf_marges} - 100) , 'Web : www.boonga.com - Email : email@boonga.com');
